                    ...
                    PurchasedProductFileIDs = orders
                        ...
                        return order.products.map(function (product) {
                            if (typeof product === "string")
                                return req.payload.logger.error("Search depth not sufficient to find purchase ID.");
                        ...
                        .filter(Boolean)
                        .flat();
                    return [2 /*return*/, { id: { in: __spreadArray(__spreadArray([], ownProductFileIDs, true), PurchasedProductFileIDs, true) } }];
            }
        });
    });
};
