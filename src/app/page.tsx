...
const perks = [
  {
    ...
    description:
      "All assets are available for instant download after purchase.",
  },
  {
  ...
  },
  {
    ...
    Icon: Leaf,
    description:
      "We plant a tree for every asset sold on our platform. We're proud to be a climate positive company.",
  },
];
